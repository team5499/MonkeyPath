...
!(function (a, b) {
  ...
  let c = [],
    ...
    m = l.toString,
    n = m.call(Object),
    o = {}; function p(a, b) { b = b || d; const c = b.createElement('script'); c.text = a, b.head.appendChild(c).parentNode.removeChild(c); } var q = '3.1.1',
    ...
    let a,
      ...
      h = 1,
      i = arguments.length,
      j = !1; for (typeof g === 'boolean' && (j = g, g = arguments[h] || {}, h++), typeof g === 'object' || r.isFunction(g) || (g = {}), h === i && (g = this, h--); h < i; h++) if ((a = arguments[h]) != null) for (b in a)c = g[b], d = a[b], g !== d && (j && d && (r.isPlainObject(d) || (e = r.isArray(d))) ? (e ? (e = !1, f = c && r.isArray(c) ? c : []) : f = c && r.isPlainObject(c) ? c : {}, g[b] = r.extend(j, f, d)) : void 0 !== d && (g[b] = d)); return g;
  }, r.extend({
    ...
    filter(a) { return this.pushStack(D(this, a || [], !1)); },
    not(a) { return this.pushStack(D(this, a || [], !0)); },
    is(a) { return !!D(this, typeof a === 'string' && A.test(a) ? r(a) : a || [], !1).length; },
  }); let E,
    F = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
    ...
    }; G.prototype = r.fn, E = r(d); let H = /^(?:parents|prev(?:Until|All))/,
    I = {
    ...
    a = typeof a === 'string' ? L(a) : r.extend({}, a); var b,
      c,
      d,
      e,
      f = [],
            ...
            let f = 0; function g(b, c, d, e) {
              return function () {
                var h = this,
                  ...
                  j = function () {
                    let a,
                      j; if (!(b < f)) { if (a = d.apply(h, i), a === c.promise()) throw new TypeError('Thenable self-resolution'); j = a && (typeof a === 'object' || typeof a === 'function') && a.then, r.isFunction(j) ? e ? j.call(a, g(f, c, M, e), g(f, c, N, e)) : (f++, j.call(a, g(f, c, M, e), g(f, c, N, e), g(f, c, M, c.notifyWith))) : (d !== M && (h = void 0, i = [a]), (e || c.resolveWith)(h, i)); }
                  },
                  k = e ? j : function () { try { j(); } catch (a) { r.Deferred.exceptionHook && r.Deferred.exceptionHook(a, k.stackTrace), b + 1 >= f && (d !== N && (h = void 0, i = [a]), c.rejectWith(h, i)); } }; b ? k() : (r.Deferred.getStackHook && (k.stackTrace = r.Deferred.getStackHook()), a.setTimeout(k));
              };
            } return r.Deferred((a) => { c[0][3].add(g(0, a, r.isFunction(e) ? e : M, a.notifyWith)), c[1][3].add(g(0, a, r.isFunction(b) ? b : M)), c[2][3].add(g(0, a, r.isFunction(d) ? d : N)); }).promise();
          },
    ...
    when(a) {
      let b = arguments.length,
        ...
        e = f.call(arguments),
        g = r.Deferred(),
        h = function (a) { return function (c) { d[a] = this, e[a] = arguments.length > 1 ? f.call(arguments) : c, --b || g.resolveWith(d, e); }; }; if (b <= 1 && (O(a, g.done(h(c)).resolve, g.reject), g.state() === 'pending' || r.isFunction(e[c] && e[c].then))) return g.then(); while (c--)O(e[c], h(c), g.reject); return g.promise();
    },
    ...
    a.removeEventListener('load', R), r.ready();
      ...
      let h = 0,
        i = a.length,
        j = c == null; if (r.type(c) === 'object') { e = !0; for (h in c)S(a, b, h, c[h], !0, f, g); } else if (void 0 !== d && (e = !0, r.isFunction(d) || (g = !0), j && (g ? (b.call(a, d), b = null) : (j = b, b = function (a, b, c) { return j.call(r(a), c); })), b)) for (;h < i; h++)b(a[h], c, g ? d : d.call(a[h], h, b(a[h], c))); return e ? a : j ? b.call(a) : i ? b(a[0], c) : f;
    },
    T = function (a) { return a.nodeType === 1 || a.nodeType === 9 || !+a.nodeType; }; function U() { this.expando = r.expando + U.uid++; }U.uid = 1, U.prototype = {
    cache(a) { let b = a[this.expando]; return b || (b = {}, T(a) && (a.nodeType ? a[this.expando] = b : Object.defineProperty(a, this.expando, { value: b, configurable: !0 }))), b; },
    set(a, b, c) {
      let d,
    ...
    remove(a, b) {
      let c,
        d = a[this.expando]; if (void 0 !== d) { if (void 0 !== b) { r.isArray(b) ? b = b.map(r.camelCase) : (b = r.camelCase(b), b = b in d ? [b] : b.match(K) || []), c = b.length; while (c--) delete d[b[c]]; }(void 0 === b || r.isEmptyObject(d)) && (a.nodeType ? a[this.expando] = void 0 : delete a[this.expando]); }
    },
    ...
    data(a, b) {
      let c,
        ...
        e,
        f = this[0],
        g = f && f.attributes; if (void 0 === a) { if (this.length && (e = W.get(f), f.nodeType === 1 && !V.get(f, 'hasDataAttrs'))) { c = g.length; while (c--)g[c] && (d = g[c].name, d.indexOf('data-') === 0 && (d = r.camelCase(d.slice(5)), $(f, d, e[d]))); V.set(f, 'hasDataAttrs', !0); } return e; } return typeof a === 'object' ? this.each(function () { W.set(this, a); }) : S(this, function (b) { let c; if (f && void 0 === b) { if (c = W.get(f, a), void 0 !== c) return c; if (c = $(f, a), void 0 !== c) return c; } else this.each(function () { W.set(this, a, b); }); }, null, b, arguments.length > 1, null, !0);
    },
    removeData(a) { return this.each(function () { W.remove(this, a); }); },
  }), r.extend({
    queue(a, b, c) { let d; if (a) return b = `${b || 'fx'}queue`, d = V.get(a, b), c && (!d || r.isArray(c) ? d = V.access(a, b, r.makeArray(c)) : d.push(c)), d || []; },
    dequeue(a, b) {
    ...
    _queueHooks(a, b) { const c = `${b}queueHooks`; return V.get(a, c) || V.access(a, c, { empty: r.Callbacks('once memory').add(() => { V.remove(a, [`${b}queue`, c]); }) }); },
  }), r.fn.extend({
    ...
    promise(a, b) {
      let c,
        ...
        f = this,
        g = this.length,
        h = function () { --d || e.resolveWith(f, [f]); }; typeof a !== 'string' && (b = a, a = void 0), a = a || 'fx'; while (g--)c = V.get(f[g], `${a}queueHooks`), c && c.empty && (d++, c.empty.add(h)); return h(), e.promise(b);
    },
  }); let _ = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    aa = new RegExp(`^(?:([+-])=|)(${_})([a-z%]*)$`, 'i'),
    ba = ['Top', 'Right', 'Bottom', 'Left'],
    ca = function (a, b) { return a = b || a, a.style.display === 'none' || a.style.display === '' && r.contains(a.ownerDocument, a) && r.css(a, 'display') === 'none'; },
    da = function (a, b, c, d) {
      let e,
        f,
    ...
    on(a, b, c, d) { return xa(this, a, b, c, d); },
    one(a, b, c, d) { return xa(this, a, b, c, d, 1); },
    off(a, b, c) {
      let d,
        e; if (a && a.preventDefault && a.handleObj) return d = a.handleObj, r(a.delegateTarget).off(d.namespace ? `${d.origType}.${d.namespace}` : d.origType, d.selector, d.handler), this; if (typeof a === 'object') { for (e in a) this.off(e, b, a[e]); return this; } return b !== !1 && typeof b !== 'function' || (c = b, b = void 0), c === !1 && (c = va), this.each(function () { r.event.remove(this, a, c, b); });
    },
  }); let ya = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
    za = /<script|<style|<link/i,
    Aa = /checked\s*(?:[^=]|=\s*.checked.)/i,
    Ba = /^true\/(.*)/,
    Ca = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g; function Da(a, b) { return r.nodeName(a, 'table') && r.nodeName(b.nodeType !== 11 ? b : b.firstChild, 'tr') ? a.getElementsByTagName('tbody')[0] || a : a; } function Ea(a) { return a.type = `${a.getAttribute('type') !== null}/${a.type}`, a; } function Fa(a) { const b = Ba.exec(a.type); return b ? a.type = b[1] : a.removeAttribute('type'), a; } function Ga(a, b) {
    let c,
      d,
      e,
      f,
      ...
      h,
      i,
      j; if (b.nodeType === 1) { if (V.hasData(a) && (f = V.access(a), g = V.set(b, f), j = f.events)) { delete g.handle, g.events = {}; for (e in j) for (c = 0, d = j[e].length; c < d; c++)r.event.add(b, e, j[e][c]); }W.hasData(a) && (h = W.access(a), i = r.extend({}, h), W.set(b, i)); }
  } function Ha(a, b) { const c = b.nodeName.toLowerCase(); c === 'input' && ia.test(a.type) ? b.checked = a.checked : c !== 'input' && c !== 'textarea' || (b.defaultValue = a.defaultValue); } function Ia(a, b, c, d) {
    b = g.apply([], b); let e,
      f,
      h,
      i,
      ...
      n = m - 1,
      q = b[0],
      s = r.isFunction(q); if (s || m > 1 && typeof q === 'string' && !o.checkClone && Aa.test(q)) return a.each(function (e) { const f = a.eq(e); s && (b[0] = q.call(this, e, f.html())), Ia(f, b, c, d); }); if (m && (e = pa(b, a[0].ownerDocument, !1, a, d), f = e.firstChild, e.childNodes.length === 1 && (e = f), f || d)) { for (h = r.map(ma(e, 'script'), Ea), i = h.length; l < m; l++)j = e, l !== n && (j = r.clone(j, !0, !0), i && r.merge(h, ma(j, 'script'))), c.call(a[l], j, l); if (i) for (k = h[h.length - 1].ownerDocument, r.map(h, Fa), l = 0; l < i; l++)j = h[l], ka.test(j.type || '') && !V.access(j, 'globalEval') && r.contains(k, j) && (j.src ? r._evalUrl && r._evalUrl(j.src) : p(j.textContent.replace(Ca, ''), k)); } return a;
  } function Ja(a, b, c) { for (var d, e = b ? r.filter(b, a) : a, f = 0; (d = e[f]) != null; f++)c || d.nodeType !== 1 || r.cleanData(ma(d)), d.parentNode && (c && r.contains(d.ownerDocument, d) && na(ma(d, 'script')), d.parentNode.removeChild(d)); return a; }r.extend({
    htmlPrefilter(a) { return a.replace(ya, '<$1></$2>'); },
    clone(a, b, c) {
      let d,
        e,
        f,
        g,
        h = a.cloneNode(!0),
        i = r.contains(a.ownerDocument, a); if (!(o.noCloneChecked || a.nodeType !== 1 && a.nodeType !== 11 || r.isXMLDoc(a))) for (g = ma(h), f = ma(a), d = 0, e = f.length; d < e; d++)Ha(f[d], g[d]); if (b) if (c) for (f = f || ma(a), g = g || ma(h), d = 0, e = f.length; d < e; d++)Ga(f[d], g[d]); else Ga(a, h); return g = ma(h, 'script'), g.length > 0 && na(g, !i && ma(a, 'script')), h;
    },
    cleanData(a) { for (var b, c, d, e = r.event.special, f = 0; void 0 !== (c = a[f]); f++) if (T(c)) { if (b = c[V.expando]) { if (b.events) for (d in b.events)e[d] ? r.event.remove(c, d) : r.removeEvent(c, d, b.handle); c[V.expando] = void 0; }c[W.expando] && (c[W.expando] = void 0); } },
  }), r.fn.extend({
    detach(a) { return Ja(this, a, !0); },
    remove(a) { return Ja(this, a); },
    text(a) { return S(this, function (a) { return void 0 === a ? r.text(this) : this.empty().each(function () { this.nodeType !== 1 && this.nodeType !== 11 && this.nodeType !== 9 || (this.textContent = a); }); }, null, a, arguments.length); },
    append() { return Ia(this, arguments, function (a) { if (this.nodeType === 1 || this.nodeType === 11 || this.nodeType === 9) { const b = Da(this, a); b.appendChild(a); } }); },
    prepend() { return Ia(this, arguments, function (a) { if (this.nodeType === 1 || this.nodeType === 11 || this.nodeType === 9) { const b = Da(this, a); b.insertBefore(a, b.firstChild); } }); },
    before() { return Ia(this, arguments, function (a) { this.parentNode && this.parentNode.insertBefore(a, this); }); },
    after() { return Ia(this, arguments, function (a) { this.parentNode && this.parentNode.insertBefore(a, this.nextSibling); }); },
    empty() { for (var a, b = 0; (a = this[b]) != null; b++)a.nodeType === 1 && (r.cleanData(ma(a, !1)), a.textContent = ''); return this; },
    clone(a, b) { return a = a != null && a, b = b == null ? a : b, this.map(function () { return r.clone(this, a, b); }); },
    html(a) {
      return S(this, function (a) {
        let b = this[0] || {},
          c = 0,
          d = this.length; if (void 0 === a && b.nodeType === 1) return b.innerHTML; if (typeof a === 'string' && !za.test(a) && !la[(ja.exec(a) || ['', ''])[1].toLowerCase()]) { a = r.htmlPrefilter(a); try { for (;c < d; c++)b = this[c] || {}, b.nodeType === 1 && (r.cleanData(ma(b, !1)), b.innerHTML = a); b = 0; } catch (e) {} }b && this.empty().append(a);
      }, null, a, arguments.length);
    },
    replaceWith() { const a = []; return Ia(this, arguments, function (b) { const c = this.parentNode; r.inArray(this, a) < 0 && (r.cleanData(ma(this)), c && c.replaceChild(b, this)); }, a); },
  }), r.each({
    appendTo: 'append', prependTo: 'prepend', insertBefore: 'before', insertAfter: 'after', replaceAll: 'replaceWith',
  }, (a, b) => { r.fn[a] = function (a) { for (var c, d = [], e = r(a), f = e.length - 1, g = 0; g <= f; g++)c = g === f ? this : this.clone(!0), r(e[g])[b](c), h.apply(d, c.get()); return this.pushStack(d); }; }); let Ka = /^margin/,
    La = new RegExp(`^(${_})(?!px)[a-z%]+$`, 'i'),
    Ma = function (b) { let c = b.ownerDocument.defaultView; return c && c.opener || (c = a), c.getComputedStyle(b); }; !(function () {
    function b() { if (i) { i.style.cssText = 'box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%', i.innerHTML = '', qa.appendChild(h); const b = a.getComputedStyle(i); c = b.top !== '1%', g = b.marginLeft === '2px', e = b.width === '4px', i.style.marginRight = '50%', f = b.marginRight === '4px', qa.removeChild(h), i = null; } } var c,
      e,
      f,
      g,
  ...
  } function Oa(a, b) { return { get() { return a() ? void delete this.get : (this.get = b).apply(this, arguments); } }; } let Pa = /^(none|table(?!-c[ea]).+)/,
    Qa = { position: 'absolute', visibility: 'hidden', display: 'block' },
    Ra = { letterSpacing: '0', fontWeight: '400' },
    Sa = ['Webkit', 'Moz', 'ms'],
    Ta = d.createElement('div').style; function Ua(a) {
    if (a in Ta) return a; let b = a[0].toUpperCase() + a.slice(1),
      c = Sa.length; while (c--) if (a = Sa[c] + b, a in Ta) return a;
  } function Va(a, b, c) { const d = aa.exec(b); return d ? Math.max(0, d[2] - (c || 0)) + (d[3] || 'px') : b; } function Wa(a, b, c, d, e) {
    let f,
      g = 0; for (f = c === (d ? 'border' : 'content') ? 4 : b === 'width' ? 1 : 0; f < 4; f += 2)c === 'margin' && (g += r.css(a, c + ba[f], !0, e)), d ? (c === 'content' && (g -= r.css(a, `padding${ba[f]}`, !0, e)), c !== 'margin' && (g -= r.css(a, `border${ba[f]}Width`, !0, e))) : (g += r.css(a, `padding${ba[f]}`, !0, e), c !== 'padding' && (g += r.css(a, `border${ba[f]}Width`, !0, e))); return g;
  } function Xa(a, b, c) {
    let d,
      e = !0,
      f = Ma(a),
      g = r.css(a, 'boxSizing', !1, f) === 'border-box'; if (a.getClientRects().length && (d = a.getBoundingClientRect()[b]), d <= 0 || d == null) { if (d = Na(a, b, f), (d < 0 || d == null) && (d = a.style[b]), La.test(d)) return d; e = g && (o.boxSizingReliable() || d === a.style[b]), d = parseFloat(d) || 0; } return `${d + Wa(a, b, c || (g ? 'border' : 'content'), e, f)}px`;
  }r.extend({
    ...
    css(a, b, c, d) {
      let e,
        f,
        g,
        h = r.camelCase(b); return b = r.cssProps[h] || (r.cssProps[h] = Ua(h) || h), g = r.cssHooks[b] || r.cssHooks[h], g && 'get' in g && (e = g.get(a, !0, c)), void 0 === e && (e = Na(a, b, d)), e === 'normal' && b in Ra && (e = Ra[b]), c === '' || c ? (f = parseFloat(e), c === !0 || isFinite(f) ? f || 0 : e) : e;
    },
  }), r.each(['height', 'width'], (a, b) => {
    r.cssHooks[b] = {
      get(a, c, d) { if (c) return !Pa.test(r.css(a, 'display')) || a.getClientRects().length && a.getBoundingClientRect().width ? Xa(a, b, d) : da(a, Qa, () => Xa(a, b, d)); },
      set(a, c, d) {
        let e,
          f = d && Ma(a),
          g = d && Wa(a, b, d, r.css(a, 'boxSizing', !1, f) === 'border-box', f); return g && (e = aa.exec(c)) && (e[3] || 'px') !== 'px' && (a.style[b] = c, c = r.css(a, b)), Va(a, c, g);
      },
    };
  }), r.cssHooks.marginLeft = Oa(o.reliableMarginLeft, (a, b) => { if (b) return `${parseFloat(Na(a, 'marginLeft')) || a.getBoundingClientRect().left - da(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)}px`; }), r.each({ margin: '', padding: '', border: 'Width' }, (a, b) => { r.cssHooks[a + b] = { expand(c) { for (var d = 0, e = {}, f = typeof c === 'string' ? c.split(' ') : [c]; d < 4; d++)e[a + ba[d] + b] = f[d] || f[d - 2] || f[0]; return e; } }, Ka.test(a) || (r.cssHooks[a + b].set = Va); }), r.fn.extend({
    css(a, b) {
      return S(this, (a, b, c) => {
        let d,
          e,
          f = {},
          g = 0; if (r.isArray(b)) { for (d = Ma(a), e = b.length; g < e; g++)f[b[g]] = r.css(a, b[g], !1, d); return f; } return void 0 !== c ? r.style(a, b, c) : r.css(a, b);
      }, a, b, arguments.length > 1);
    },
  }); function Ya(a, b, c, d, e) { return new Ya.prototype.init(a, b, c, d, e); }r.Tween = Ya, Ya.prototype = {
    constructor: Ya,
    ...
    cur() { const a = Ya.propHooks[this.prop]; return a && a.get ? a.get(this) : Ya.propHooks._default.get(this); },
    run(a) {
      let b,
    ...
    animate(a, b, c, d) {
      let e = r.isEmptyObject(a),
        f = r.speed(b, c, d),
        g = function () { const b = hb(this, r.extend({}, a), f); (e || V.get(this, 'finish')) && b.stop(!0); }; return g.finish = g, e || f.queue === !1 ? this.each(g) : this.queue(f.queue, g);
    },
    stop(a, b, c) {
      const d = function (a) { const b = a.stop; delete a.stop, b(c); }; return typeof a !== 'string' && (c = b, b = a, a = void 0), b && a !== !1 && this.queue(a || 'fx', []), this.each(function () {
        let b = !0,
          ...
          f = r.timers,
          g = V.get(this); if (e)g[e] && g[e].stop && d(g[e]); else for (e in g)g[e] && g[e].stop && ab.test(e) && d(g[e]); for (e = f.length; e--;)f[e].elem !== this || a != null && f[e].queue !== a || (f[e].anim.stop(c), b = !1, f.splice(e, 1)); !b && c || r.dequeue(this, a);
      });
    },
    finish(a) {
    ...
    jb = r.expr.attrHandle; r.fn.extend({ attr(a, b) { return S(this, r.attr, a, b, arguments.length > 1); }, removeAttr(a) { return this.each(function () { r.removeAttr(this, a); }); } }), r.extend({
    attr(a, b, c) {
      let d,
        e,
    ...
    removeAttr(a, b) {
      let c,
        d = 0,
        e = b && b.match(K); if (e && a.nodeType === 1) while (c = e[d++])a.removeAttribute(c);
    },
  }), ib = { set(a, b, c) { return b === !1 ? r.removeAttr(a, c) : a.setAttribute(c, c), c; } }, r.each(r.expr.match.bool.source.match(/\w+/g), (a, b) => {
    const c = jb[b] || r.find.attr; jb[b] = function (a, b, d) {
      let e,
        f,
        g = b.toLowerCase(); return d || (f = jb[g], jb[g] = e, e = c(a, b, d) != null ? g : null, jb[g] = f), e;
    };
  }); let kb = /^(?:input|select|textarea|button)$/i,
    lb = /^(?:a|area)$/i; r.fn.extend({ prop(a, b) { return S(this, r.prop, a, b, arguments.length > 1); }, removeProp(a) { return this.each(function () { delete this[r.propFix[a] || a]; }); } }), r.extend({
    prop(a, b, c) {
      let d,
        e,
    ...
    propHooks: { tabIndex: { get(a) { const b = r.find.attr(a, 'tabindex'); return b ? parseInt(b, 10) : kb.test(a.nodeName) || lb.test(a.nodeName) && a.href ? 0 : -1; } } },
    ...
    addClass(a) {
      let b,
        ...
        g,
        h,
        i = 0; if (r.isFunction(a)) return this.each(function (b) { r(this).addClass(a.call(this, b, nb(this))); }); if (typeof a === 'string' && a) { b = a.match(K) || []; while (c = this[i++]) if (e = nb(c), d = c.nodeType === 1 && ` ${mb(e)} `) { g = 0; while (f = b[g++])d.indexOf(` ${f} `) < 0 && (d += `${f} `); h = mb(d), e !== h && c.setAttribute('class', h); } } return this;
    },
    removeClass(a) {
      let b,
        c,
        ...
        g,
        h,
        i = 0; if (r.isFunction(a)) return this.each(function (b) { r(this).removeClass(a.call(this, b, nb(this))); }); if (!arguments.length) return this.attr('class', ''); if (typeof a === 'string' && a) { b = a.match(K) || []; while (c = this[i++]) if (e = nb(c), d = c.nodeType === 1 && ` ${mb(e)} `) { g = 0; while (f = b[g++]) while (d.indexOf(` ${f} `) > -1)d = d.replace(` ${f} `, ' '); h = mb(d), e !== h && c.setAttribute('class', h); } } return this;
    },
    toggleClass(a, b) {
      const c = typeof a; return typeof b === 'boolean' && c === 'string' ? b ? this.addClass(a) : this.removeClass(a) : r.isFunction(a) ? this.each(function (c) { r(this).toggleClass(a.call(this, c, nb(this), b), b); }) : this.each(function () {
        let b,
          d,
          e,
          f; if (c === 'string') { d = 0, e = r(this), f = a.match(K) || []; while (b = f[d++])e.hasClass(b) ? e.removeClass(b) : e.addClass(b); } else void 0 !== a && c !== 'boolean' || (b = nb(this), b && V.set(this, '__className__', b), this.setAttribute && this.setAttribute('class', b || a === !1 ? '' : V.get(this, '__className__') || ''));
      });
    },
    hasClass(a) {
      let b,
        c,
        d = 0; b = ` ${a} `; while (c = this[d++]) if (c.nodeType === 1 && (` ${mb(nb(c))} `).indexOf(b) > -1) return !0; return !1;
    },
  }); const ob = /\r/g; r.fn.extend({
    val(a) {
      let b,
        c,
        d,
        e = this[0]; { if (arguments.length) return d = r.isFunction(a), this.each(function (c) { let e; this.nodeType === 1 && (e = d ? a.call(this, c, r(this).val()) : a, e == null ? e = '' : typeof e === 'number' ? e += '' : r.isArray(e) && (e = r.map(e, a => (a == null ? '' : `${a}`))), b = r.valHooks[this.type] || r.valHooks[this.nodeName.toLowerCase()], b && 'set' in b && void 0 !== b.set(this, e, 'value') || (this.value = e)); }); if (e) return b = r.valHooks[e.type] || r.valHooks[e.nodeName.toLowerCase()], b && 'get' in b && void 0 !== (c = b.get(e, 'value')) ? c : (c = e.value, typeof c === 'string' ? c.replace(ob, '') : c == null ? '' : c); }
    },
  }), r.extend({
    valHooks: {
      option: { get(a) { const b = r.find.attr(a, 'value'); return b != null ? b : mb(r.text(a)); } },
      select: {
        get(a) {
          let b,
            c,
            ...
            g = a.type === 'select-one',
            h = g ? null : [],
            i = g ? f + 1 : e.length; for (d = f < 0 ? i : g ? f : 0; d < i; d++) if (c = e[d], (c.selected || d === f) && !c.disabled && (!c.parentNode.disabled || !r.nodeName(c.parentNode, 'optgroup'))) { if (b = r(c).val(), g) return b; h.push(b); } return h;
        },
        set(a, b) {
          let c,
            d,
  ...
  }), r.each(['radio', 'checkbox'], function () { r.valHooks[this] = { set(a, b) { if (r.isArray(b)) return a.checked = r.inArray(r(a).val(), b) > -1; } }, o.checkOn || (r.valHooks[this].get = function (a) { return a.getAttribute('value') === null ? 'on' : a.value; }); }); const pb = /^(?:focusinfocus|focusoutblur)$/; r.extend(r.event, {
    trigger(b, c, e, f) {
      let g,
        h,
        i,
    ...
    rb = r.now(),
    sb = /\?/; r.parseXML = function (b) { let c; if (!b || typeof b !== 'string') return null; try { c = (new a.DOMParser()).parseFromString(b, 'text/xml'); } catch (d) { c = void 0; } return c && !c.getElementsByTagName('parsererror').length || r.error(`Invalid XML: ${b}`), c; }; let tb = /\[\]$/,
    ub = /\r?\n/g,
    vb = /^(?:submit|button|image|reset|file)$/i,
    wb = /^(?:input|select|textarea|keygen)/i; function xb(a, b, c, d) { let e; if (r.isArray(b))r.each(b, (b, e) => { c || tb.test(a) ? d(a, e) : xb(`${a}[${typeof e === 'object' && e != null ? b : ''}]`, e, c, d); }); else if (c || r.type(b) !== 'object')d(a, b); else for (e in b)xb(`${a}[${e}]`, b[e], c, d); }r.param = function (a, b) {
    let c,
      d = [],
      e = function (a, b) { const c = r.isFunction(b) ? b() : b; d[d.length] = `${encodeURIComponent(a)}=${encodeURIComponent(c == null ? '' : c)}`; }; if (r.isArray(a) || a.jquery && !r.isPlainObject(a))r.each(a, function () { e(this.name, this.value); }); else for (c in a)xb(c, a[c], b, e); return d.join('&');
    ...
    let e = {},
      f = a === Gb; function g(h) { let i; return e[h] = !0, r.each(a[h] || [], (a, h) => { const j = h(b, c, d); return typeof j !== 'string' || f || e[j] ? f ? !(i = j) : void 0 : (b.dataTypes.unshift(j), g(j), !1); }), i; } return g(b.dataTypes[0]) || !e['*'] && g('*');
  } function Lb(a, b) {
    let c,
      d,
    ...
    ajax(b, c) {
      typeof b === 'object' && (c = b, b = void 0), c = c || {}; var e,
        ...
        let j,
          ...
          v,
          w,
          x = c; k || (k = !0, i && a.clearTimeout(i), e = void 0, g = h || '', y.readyState = b > 0 ? 4 : 0, j = b >= 200 && b < 300 || b === 304, d && (v = Mb(o, y, d)), v = Nb(o, v, y, j), j ? (o.ifModified && (w = y.getResponseHeader('Last-Modified'), w && (r.lastModified[f] = w), w = y.getResponseHeader('etag'), w && (r.etag[f] = w)), b === 204 || o.type === 'HEAD' ? x = 'nocontent' : b === 304 ? x = 'notmodified' : (x = v.state, m = v.data, n = v.error, j = !n)) : (n = x, !b && x || (x = 'error', b < 0 && (b = 0))), y.status = b, y.statusText = `${c || x}`, j ? s.resolveWith(p, [m, x, y]) : s.rejectWith(p, [y, x, n]), y.statusCode(u), u = void 0, l && q.trigger(j ? 'ajaxSuccess' : 'ajaxError', [y, o, j ? m : n]), t.fireWith(p, [y, x]), l && (q.trigger('ajaxComplete', [y, o]), --r.active || r.event.trigger('ajaxStop')));
      } return y;
    },
  ...
  }), r.expr.pseudos.hidden = function (a) { return !r.expr.pseudos.visible(a); }, r.expr.pseudos.visible = function (a) { return !!(a.offsetWidth || a.offsetHeight || a.getClientRects().length); }, r.ajaxSettings.xhr = function () { try { return new a.XMLHttpRequest(); } catch (b) {} }; let Ob = { 0: 200, 1223: 204 },
    Pb = r.ajaxSettings.xhr(); o.cors = !!Pb && 'withCredentials' in Pb, o.ajax = Pb = !!Pb, r.ajaxTransport((b) => {
    let c,
      d; if (o.cors || Pb && !b.crossDomain) {
      return {
        send(e, f) {
          let g,
    ...
    if (typeof a !== 'string') return []; typeof b === 'boolean' && (c = b, b = !1); let e,
      f,
      g; return b || (o.createHTMLDocument ? (b = d.implementation.createHTMLDocument(''), e = b.createElement('base'), e.href = d.location.href, b.head.appendChild(e)) : b = d), f = B.exec(a), g = !c && [], f ? [b.createElement(f[1])] : (f = pa([a], b, g), g && g.length && r(g).remove(), r.merge([], f.childNodes));
  }, r.fn.load = function (a, b, c) {
    let d,
      e,
      f,
      g = this,
      h = a.indexOf(' '); return h > -1 && (d = mb(a.slice(h)), a = a.slice(0, h)), r.isFunction(b) ? (c = b, b = void 0) : b && typeof b === 'object' && (e = 'POST'), g.length > 0 && r.ajax({
  ...
  }, r.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (a, b) => { r.fn[b] = function (a) { return this.on(b, a); }; }), r.expr.pseudos.animated = function (a) { return r.grep(r.timers, b => a === b.elem).length; }; function Sb(a) { return r.isWindow(a) ? a : a.nodeType === 9 && a.defaultView; }r.offset = {
    setOffset(a, b, c) {
      let d,
        e,
        f,
    ...
    position() {
      if (this[0]) {
        let a,
          b,
          c = this[0],
          d = { top: 0, left: 0 }; return r.css(c, 'position') === 'fixed' ? b = c.getBoundingClientRect() : (a = this.offsetParent(), b = this.offset(), r.nodeName(a[0], 'html') || (d = a.offset()), d = { top: d.top + r.css(a[0], 'borderTopWidth', !0), left: d.left + r.css(a[0], 'borderLeftWidth', !0) }), { top: b.top - d.top - r.css(c, 'marginTop', !0), left: b.left - d.left - r.css(c, 'marginLeft', !0) };
      }
    },
    offsetParent() { return this.map(function () { let a = this.offsetParent; while (a && r.css(a, 'position') === 'static')a = a.offsetParent; return a || qa; }); },
  }), r.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (a, b) => { const c = b === 'pageYOffset'; r.fn[a] = function (d) { return S(this, (a, d, e) => { const f = Sb(a); return void 0 === e ? f ? f[b] : a[d] : void (f ? f.scrollTo(c ? f.pageXOffset : e, c ? e : f.pageYOffset) : a[d] = e); }, a, d, arguments.length); }; }), r.each(['top', 'left'], (a, b) => { r.cssHooks[b] = Oa(o.pixelPosition, (a, c) => { if (c) return c = Na(a, b), La.test(c) ? `${r(a).position()[b]}px` : c; }); }), r.each({ Height: 'height', Width: 'width' }, (a, b) => {
    r.each({ padding: `inner${a}`, content: b, '': `outer${a}` }, (c, d) => {
      r.fn[d] = function (e, f) {
        let g = arguments.length && (c || typeof e !== 'boolean'),
          h = c || (e === !0 || f === !0 ? 'margin' : 'border'); return S(this, (b, c, e) => { let f; return r.isWindow(b) ? d.indexOf('outer') === 0 ? b[`inner${a}`] : b.document.documentElement[`client${a}`] : b.nodeType === 9 ? (f = b.documentElement, Math.max(b.body[`scroll${a}`], f[`scroll${a}`], b.body[`offset${a}`], f[`offset${a}`], f[`client${a}`])) : void 0 === e ? r.css(b, c, h) : r.style(b, c, e, h); }, b, g ? e : void 0, g);
      };
    });
  }), r.fn.extend({
  ...
  }), r.parseJSON = JSON.parse, typeof define === 'function' && define.amd && define('jquery', [], () => r); let Tb = a.jQuery,
